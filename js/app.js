...
const icons = {
  ...
  mail: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M4.5 5h15A2.5 2.5 0 0 1 22 7.5v9A2.5 2.5 0 0 1 19.5 19h-15A2.5 2.5 0 0 1 2 16.5v-9A2.5 2.5 0 0 1 4.5 5Zm0 2a.5.5 0 0 0-.5.5v.42l8 4.9 8-4.9V7.5a.5.5 0 0 0-.5-.5h-15Zm15 10a.5.5 0 0 0 .5-.5v-6.14l-7.48 4.58a1 1 0 0 1-1.04 0L4 10.36v6.14a.5.5 0 0 0 .5.5h15Z"/></svg>',
